...
class Window(QMainWindow):
    def __init__(self):
        ...
        TestA = QAction("&Change Values", self)
        
        TestB = QAction("&Restart Blackjack Game", self)
        TestB.triggered.connect(self.restart)

        TestC = QAction("&Reset Game", self)
        TestC.triggered.connect(self.reset)
    ...
    def home(self):
        ...
        self.invalidMoney = QMessageBox()
        self.invalidMoney.setWindowTitle("Tutorial on PyQt5")
        self.invalidMoney.setText("This is the main text!")
        self.invalidMoney.setIcon(QMessageBox.Critical)
