...
class Window(QMainWindow):
    ...
    def home(self):
        ...
        self.money.move(20, 30)
        self.money.resize(200,  50)
        self.player = QLabel("", self)
        self.player.setStyleSheet(("background-color: transparency;"))
        font = QFont()
        ...
        self.dealer.setStyleSheet(("background-color: red;"))
